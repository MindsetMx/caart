export interface LastChanceAuctionVehicleDetail {
  auctionCar: LastChanceAuctionVehicleAuctionCar;
  lastChanceAuction: LastChanceAuctionVehicleDetailLastChanceAuction;
...
export interface LastChanceAuctionVehicleAuctionCar {
  _id: string;
  type: string;
  brand: string;
  year: number;
...
export interface LastChanceAuctionVehicleDetailLastChanceAuction {
  _id: string;
  originalAuctionCarId: string;
