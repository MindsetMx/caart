...
export class StickyAuctionInfoBarComponent {
  auction = input.required<AuctionDetails | LastChanceAuctionVehicleDetail>();
  ...
  hasPremiumProperty(auction: AuctionDetails | LastChanceAuctionVehicleDetail): boolean {
    return auction && auction.data && 'premium' in auction.data.attributes;
  }
